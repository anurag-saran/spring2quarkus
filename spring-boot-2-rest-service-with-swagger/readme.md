...
### /src/main/java/com/acmebank/springboot/rest/example/student/Student.java

```java
package com.acmebank.springboot.rest.example.student;
...
### /src/main/java/com/acmebank/springboot/rest/example/student/StudentNotFoundException.java
...
### /src/main/java/com/acmebank/springboot/rest/example/student/StudentRepository.java
...
### /src/main/java/com/acmebank/springboot/rest/example/student/StudentResource.java
...
### /src/main/java/com/acmebank/springboot/rest/example/swagger/ApiDocumentationConfig.java

```java
package com.acmebank.springboot.rest.example.swagger;
...
@OpenAPIDefinition(
        info = @Info(
                ...
                contact = @Contact(
                        name = "Ranga Karanam",
                        email = "ranga.karanam@acmebank.com",
                        url = "http://www.acmebank.com"
                ),
                license = @License(
                        name = "Apache 2.0",
        ...
        servers = {@Server(url = "http://acmebank.com")}
)
...
### /src/main/java/com/acmebank/springboot/rest/example/swagger/OpenApiConfig.java
    ...
    public OpenAPI springShopOpenAPI() {
        return new OpenAPI()
                ...
                .externalDocs(new ExternalDocumentation()
                        .description("Ranga Karanam, acmebank@gmail.com")
                        .url("http://www.acmebank.com"));
    }
